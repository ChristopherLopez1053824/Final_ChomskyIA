...
st.set_page_config(page_title="Chomsky IA", page_icon="", layout="wide")
...
st.title("Chomsky IA")
st.markdown("<p style='text-align: center; font-size: 1.1rem;'>Analizador de lenguajes</p>", unsafe_allow_html=True)
